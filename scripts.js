...
function popular(membrosJson) {
  ...
  for (let i = 0; i < membros.length; i++) {
    ...
    document.getElementById(membrosJson.membrosLista[i].nome).addEventListener("mouseover",function(){mouseOver(this)})
...
function mouseOver(img){
  ...
  img.addEventListener("mousemove",setTimeout(function(){mostrarInfoBox(infoBox)}, 200))
  img.addEventListener("mouseout", function(){apagarInfoBox(infoBox)});
  function mostrarInfoBox(infoBox){
